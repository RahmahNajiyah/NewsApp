...
import com.tiara.newsapp.Fragment.CustomAdapter2;
...
public class CustomAdapter3 extends BaseAdapter {
    ...
    public CustomAdapter3(FragmentActivity mainActivity, ArrayList<Berita> data) {
        datas = data;
        c = mainActivity;
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        CustomAdapter2.ViewHolder v = new CustomAdapter2.ViewHolder(view);
